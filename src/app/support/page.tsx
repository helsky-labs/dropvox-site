      ...
      <main className="flex-1 pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">support@dropvox.app</p>
                </div>
              </a>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <FaqItem
                    question={t("faq.common.modelDownload.q")}
                    answer={t("faq.common.modelDownload.a")}
                  />
                  <FaqItem
                    question={t("faq.common.accuracy.q")}
                    answer={t("faq.common.accuracy.a")}
                  />
                  <FaqItem
                    question={t("faq.common.formats.q")}
                    answer={t("faq.common.formats.a")}
                  />
                  <FaqItem
                    question={t("faq.common.offline.q")}
                    answer={t("faq.common.offline.a")}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <FaqItem
                    question={t("faq.license.free.q")}
                    answer={t("faq.license.free.a")}
                  />
                  <FaqItem
                    question={t("faq.license.activate.q")}
                    answer={t("faq.license.activate.a")}
                  />
                  <FaqItem
                    question={t("faq.license.machines.q")}
                    answer={t("faq.license.machines.a")}
                  />
                  <FaqItem
              ...
              <div>
                ...
                <div className="space-y-4">
                  <FaqItem
                    question={t("faq.technical.requirements.q")}
                    answer={t("faq.technical.requirements.a")}
                  />
                  <FaqItem
                    question={t("faq.technical.storage.q")}
                    answer={t("faq.technical.storage.a")}
                  />
                  <FaqItem
          ...
          <section className="p-6 rounded-xl bg-slate-100 dark:bg-slate-800">
            ...
            <Link
              href="/restore"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-sm transition-colors"
            >
              {t("restore.button")}
            </Link>
          </section>
