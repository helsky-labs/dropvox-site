          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-600 dark:text-slate-400">
                <li>
                  <strong>Stripe</strong> &mdash; {t("thirdParties.stripe")}
                </li>
                <li>
                  <strong>Resend</strong> &mdash; {t("thirdParties.resend")}
                </li>
                <li>
                  <strong>Supabase</strong> &mdash; {t("thirdParties.supabase")}
                </li>
                <li>
                  <strong>TelemetryDeck</strong> &mdash; {t("thirdParties.telemetrydeck")}
                </li>
              </ul>
            </section>
