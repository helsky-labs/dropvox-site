        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            {showGetPro && (
              <Link
                href="/pricing"
                className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-4 py-2 rounded-full transition-colors active:scale-95"
              >
                {t('getPro')}
              </Link>
            )}
          ...
          <div className="px-4 py-4 space-y-1">
            ...
            {showGetPro && (
              <Link
                href="/pricing"
                onClick={closeMenu}
                className="flex items-center justify-center min-h-[44px] px-3 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium transition-colors active:scale-95"
              >
                {t('getPro')}
              </Link>
            )}
